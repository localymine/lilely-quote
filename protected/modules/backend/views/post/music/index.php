...
$this->pageTitle = "All Music" . ' | ' . Yii::app()->name;
...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-brush"></i>All Music<br />
            <?php
                                ...
                                <tr id="post-<?php echo $row->id ?>">
                                    ...
                                    <td>
                                        <div class="block-options">
                                            ...
                                            <a title="" data-toggle="tooltip" class="btn btn-alt btn-sm btn-default btn-option" href="<?php echo Yii::app()->createUrl('backend/post/updateMusic', array('id' => $row->id)) ?>" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
...
<script>
    $(function () {
        ...
        $('a.status').click(function (e) {
            ...
            var request = $.ajax({
                url: '<?php echo Yii::app()->createUrl('backend/post/statusMusic') ?>',
                type: 'POST',
                data: {id: postid},
                dataType: 'json',
                beforeSend: function () {
        ...
        $("a.delete").click(function (e) {
            ...
            if (confirm('Are you sure you want to delete this?\nCan not recover after delete.')) {
                var postid = $(this).data('postid');
                var request = $.ajax({
                    url: '<?php echo Yii::app()->createUrl('backend/post/deleteMusic') ?>',
                    type: 'POST',
                    data: {id: postid},
                    dataType: 'json',
                    beforeSend: function () {
        ...
        $("a.ordertop").click(function (e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {id: postid, post_type: 'music'},
                dataType: 'json',
                beforeSend: function () {
                    $('body').append(ajaxloader);
                },
        ...
        $('#the-list').sortable({
            ...
            'update': function (e, ui) {
                $.post('<?php echo Yii::app()->createUrl('backend/post/sortMusic') ?>', {
