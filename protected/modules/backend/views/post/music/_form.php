...
$this->pageTitle = ($update == 0) ? ("Add Music" . ' | ' . Yii::app()->name) : ("Update Music" . ' | ' . Yii::app()->name);
...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-brush"></i>Music<br /><small>...</small>
        </h1>
    </div>
</div>
    ...
    <div class="col-md-8">
        <div class="block">
            <div class="block-title">
                ...
                <?php if ($update == 1): ?>
                    <div class="block-options pull-right"><a href="<?php echo Yii::app()->createUrl('backend/post/addMusic') ?>" class="btn btn-sm btn-primary">Add New</a></div>
                <?php endif; ?>
            </div>
                ...
                <div class="tab-content">
                    ...
                    foreach (Yii::app()->params['translatedLanguages'] as $l => $lang):
                        ...
                        <div class="tab-pane fade in <?php echo $active ?>" id="<?php echo $lang; ?>">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">Info About the Composer</label>
    ...
    <div class="col-md-4">
        ...
        <div class="block clearfix">
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <?php echo CHtml::textField('Post[performer]', $model->performer, array('class' => 'form-control', 'form' => 'stories-form')) ?>
                </div>
            </div>
        </div>
        ...
        <div class="block clearfix">
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <?php echo CHtml::image(Yii::app()->baseUrl . '/images/music/' . $model->image, '', array('width' => '52')) ?>
                </div>
            </div>
        </div>
