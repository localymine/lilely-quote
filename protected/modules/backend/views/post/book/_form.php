...
$this->pageTitle = ($update == 0) ? ("Add Book" . ' | ' . Yii::app()->name) : ("Update Book" . ' | ' . Yii::app()->name);
...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-brush"></i>Books<br /><small>...</small>
        </h1>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="block">
            <div class="block-title">
                ...
                <?php if ($update == 1): ?>
                    <div class="block-options pull-right"><a href="<?php echo Yii::app()->createUrl('backend/post/addBook') ?>" class="btn btn-sm btn-primary">Add New</a></div>
                <?php endif; ?>
            </div>
                ...
                <div class="tab-content">
                    ...
                    foreach (Yii::app()->params['translatedLanguages'] as $l => $lang):
                        ...
                        <div class="tab-pane fade in <?php echo $active ?>" id="<?php echo $lang; ?>">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-offset-1">Content</label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?php echo $form->fileField($model, 'cover' . $suffix) ?>
                                    <div class="help-block">The best image size (recommend): 300 x 400</div>
                                </div>
                                <div class="col-md-2">
                                    <?php $cover = 'cover' . $suffix; ?>
                                    <?php echo CHtml::image(Yii::app()->baseUrl . '/images/book/' . $model->{$cover}, '', array('width' => '52')) ?>
                                </div>
                            </div>
    ...
    <div class="col-md-4">
        ...
        <div class="block clearfix">
            <div class="form-group">
                <label class="col-md-2 control-label">Image Introduce</label>
                <div class="col-md-8">
                    <input type="file" id="Post_image" name="Post[image]" class="" form="stories-form">
                    <div class="help-block">The best image size (recommend): 300 x 126</div>
                </div>
                <div class="col-md-2">
                    <?php echo CHtml::image(Yii::app()->baseUrl . '/images/book/' . $model->image, '', array('width' => '52')) ?>
                </div>
            </div>
        </div>
