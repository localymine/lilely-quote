...
/**
 * This is the model class for table "term_faq_relationships".
 *
 * The followings are the available columns in table 'term_faq_relationships':
 * @property string $object_id
 * @property string $term_taxonomy_id
 * @property integer $term_order
 */
class TermFaqRelationships extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'term_faq_relationships';
    }
     ...
     * @return TermFaqRelationships the static model class
     */
    public static function model($className = __CLASS__) {
        return parent::model($className);
    }
    
    public function get_relate_terms($post_id, $taxonomy = 'category') {
