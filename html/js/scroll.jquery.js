    ...
    $.fn.scrollLoad = function(options) {
        ...
        return this.each(function() {
            ...
            $(this).bind('scroll', function(e) {
                ...
                if( Math.round( $( this ).prop( 'scrollTop' ) / ( $( this ).prop( 'scrollHeight' ) - $( this ).prop( 'clientHeight' ) ) * 100 ) > defaults.ScrollAfterHeight ) {    // fix for lasted jquery
//                if (Math.round($(this).attr('scrollTop') / ($(this).attr('scrollHeight') - $(this).attr('clientHeight')) * 100) > defaults.ScrollAfterHeight) { // older jquery 1.4.2
