<?php
$this->pageTitle = 'Classical Music' . ' | ' . Yii::app()->name;
...
<?php
$post_url = Yii::app()->createUrl('music');
...
<?php
Yii::app()->clientScript->registerScript('view-more-music-' . rand(), $script, CClientScript::POS_END);
?>