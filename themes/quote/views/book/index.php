<?php
$this->pageTitle = 'Books' . ' | ' . Yii::app()->name;
...
<div class="gallery show-content">
    <div id="infinite-scroll-story" class="row bk-block book-gallery">
        <?php if ($model_story != '') $this->renderPartial('../_line/_story', array('posts' => $model_story), false); ?>
    </div>
</div>

<?php
$post_url = Yii::app()->createUrl('book');
...
<?php
Yii::app()->clientScript->registerScript('view-more-book-' . rand(), $script, CClientScript::POS_END);
?>