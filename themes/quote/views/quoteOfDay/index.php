<?php
$this->pageTitle = 'Quote Of Day' . ' | ' . Yii::app()->name;
...
<?php
$post_url = Yii::app()->createUrl('quote-of-day');
...
<?php
Yii::app()->clientScript->registerScript('view-more-quote-of-day-' . rand(), $script, CClientScript::POS_END);
?>